...
class MediaControllerTest {
    ...
    void create_ReturnsOk() {
        ...
        MediaPostVm mediaPostVm = new MediaPostVm("caption", file, "test.png");
    ...
    @Test
    void get_WhenNotExists_ReturnsNotFound() {
    ...
    @Test
    void getByIds_WhenExists_ReturnsOk() {
        MediaVm mediaVm = new MediaVm(1L, "caption", "test.png", "image/png", "url");
    ...
    @Test
    void getByIds_WhenEmpty_ReturnsNotFound() {
